...
# Usage example:                                                                                                  # 
# python sgcanner.py eu-west-1 unattached                                                                         @ 
# python sgcanner.py eu-west-1 unsecure --accesskey="ABCDEF" --secretkey="123456"                                 #
# python sgcanner.py eu-west-1 unsecure --accesskey="ABCDEF" --secretkey="123456" --ignoreports="40,80,443"       # 
###################################################################################################################
