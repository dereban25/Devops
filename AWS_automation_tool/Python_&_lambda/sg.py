...
######################################################################################################################
# Generate rule report of all the security groups                                                                    #
# Input Params: None                                                                                                 #
# Usage:        ./ec2_sg_rules.py  > date.csv   [python ./ec2_sg_rules.py > agill-dev-2018-04-11.csv ]               #                                                                                    #
# created csv file after file created you can sort  with exclel
######################################################################################################################
